...
% Initial hydrogen moles in gas phase (ideal gas law at setpoint)
...
dHrxn   = -8e4;       % J/mol, enthalpy of reaction (exothermic)
...
rhoCp   = 4.0e6;   % J/m^3-K (effective density × heat capacity)
V_liq   = 1.0;     % m^3 (liquid volume, already defined earlier)
Qmax    = 2e6;     % J/s (max heater/cooler duty)

% Heat of reaction (exothermic)
dHrxn   = -8e4;    % J/mol (tune as needed)
